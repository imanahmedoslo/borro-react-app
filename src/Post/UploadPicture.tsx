    ...
    <>
      ...
      >
        <Box
          component="img"
          src={img}
          sx={{ height: "180px", width: "auto ", borderRadius: "15px" }}
...
//style={{width:'200px', height:'50px', border:'0.5px solid grey',
// marginTop:'10px', alignSelf:'center'}}> Velg et bilde:<input type="file"
