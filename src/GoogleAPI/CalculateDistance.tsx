...
export async function calculateDistance(userAddress: string, postAddress: string): Promise<number> {
  // getGeocode seems to be defined in Maps.tsx.
  // You may want to move this function to this file or another common file so it can be imported in Maps and here.
  ...
  const distanceInMeters = window.google.maps.geometry.spherical.computeDistanceBetween(latLng1, latLng2);
