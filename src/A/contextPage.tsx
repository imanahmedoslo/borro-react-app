...
export async function LoginFunctionality(userInfo: CreateUserType) {
  ...
  // response.json() const LoginResponse: TokenAndId = { accessToken:
  // responseJson.accessToken, Id: responseJson.id, ExpiresAt:
  // responseJson.ExpiresAt, IsLoggedIn: true } localStorage.setItem('token',
  // `${LoginResponse.accessToken}`) localStorage.setItem('id',
  // `${LoginResponse.Id}`) localStorage.setItem('logInStatus',
  // `${LoginResponse.IsLoggedIn}`) localStorage.setItem('ExpiresAt',
