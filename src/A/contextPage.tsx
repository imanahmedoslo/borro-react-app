   ...
   async function getUser(){
    ...
    function handleLogOut(){
      ...
      if (profile) {
        ...
        <Typography gutterBottom variant="h4" component="div">{profile.firstName??'novalue'}</Typography>
        <Button style={{textAlign:'center', height:'50px'}} variant="contained" onClick={handleLogOut}>Logg ut</Button>
        </div>
        </>)
      }
    }
