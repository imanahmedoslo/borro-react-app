...
export default function SearchAppBar({
  ...
  // const isLoggedIn: boolean = localStorage.getItem('logInStatus') === 'true'
  // ? true : false
        ...
        <Toolbar>
          ...
          <Search sx={{ mr: 2 }}>
            ...
            <StyledInputBase
              ...
              onChange={(event) => setSearchText(event.target.value)} // update
              // search
              // text
            />
          </Search>
          {isLoggedIn ? (
            <LoggedInIcon userId={sessionInfo.id} />
          ) : (
            <Button
              sx={{
                textAlign: "center",
